<template>
    <div class="product-slider">
        <div id="product-slider" :style="{width:images.length>1 ? null : '100%'}">
            <div v-for="(item,index) in images"
                 :data-src="'/storage/'+item"
                 :key="'products-slide-'+index">
                <div class="product-slider_item"
                     :style="{backgroundImage:'url(/storage/'+item+')'}"></div>
            </div>
        </div>
        <div class="product-slider_bottom" v-show="images.length>1">
            <div id="product-slider_bottom">
                <div v-for="(item,index) in images"
                     :key="'products-slide-image'+index"
                     class="bottom-slider"
                     :style="{backgroundImage:'url(/storage/'+item+')'}"
                ></div>
            </div>
        </div>
    </div>
